        ...
        if ($('#c3chart_stacked').length) {
            var chart = c3.generate({
                ...
                data: {
                    ...
                    order: 'desc', // stack customerOrder by sum of values descendantly. this is default.
                    //      customerOrder: 'asc'  // stack customerOrder by sum of values ascendantly.
                    //      customerOrder: null   // stack customerOrder by data definition.
